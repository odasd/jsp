 ...
 * Generated at: 2020-06-15 01:54:04 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<div id=\"divHeader\"><h2>강좌목록</h2></div>\r\n");
      ...
      out.write("\t\t\t\t   <option value=\"lcode\">번호</option>            \r\n");
      out.write("\t\t\t\t   <option value=\"lname\">이름</option>            \r\n");
      out.write("\t\t\t\t   <option value=\"room\">강의실</option>\r\n");
      out.write("\t\t\t\t   <option value=\"pname\">교수이름</option>          \r\n");
      out.write("\t\t\t \t </select>            \r\n");
      ...
      out.write("       \t\t\t<td width=145>강좌이름</td>     \r\n");
      out.write("       \t\t\t<td width=70>강의시간</td>       \r\n");
      out.write("     \t\t\t<td width=100>강의실</td>        \r\n");
      out.write("    \t\t\t<td width=70>담당교수</td>         \r\n");
      out.write("   \t\t\t\t<td width=100>담당교수명</td>  \r\n");
      out.write("\t\t\t\t<td width=80>최대수강인원</td>   \r\n");
      out.write("\t\t\t\t<td width=80>수강신청인원</td>    \r\n");
      ...
      out.write("  \t\t\t\t\t<td class=\"instructor\">{{instructor}}</td>    \r\n");
      out.write("\t\t\t\t\t<td class=\"pname\">{{pname}}</td>      \r\n");
      out.write("    \t\t\t\t<td class=\"capacity\">{{capacity}}</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"person\">{{persons}}</td> \r\n");
