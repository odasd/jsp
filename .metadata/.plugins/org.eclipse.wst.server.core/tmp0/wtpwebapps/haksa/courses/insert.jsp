...
<body>
	<div id="divPage">
		...
		<div id="divContent">
		<!---------------------여기에 내용출력 시작----------------------- -->
			<div id="divHeader"><h2>강좌등록</h2></div>
				<form name="frm" action="insert" method="post">   
					<table>        
						<tr>            
							<td class="title">강좌번호</td>
							<td>
								<input type="text" size=10 name="lcode" value="C406">
							</td>    
							<td class="title" width=150>강의실</td>
							<td>
								<input type="text" size=5 name="room" value="302">
							</td>           
							<td class="title" width=150>강의시수</td>
							<td>
								<input type="text" size=5 name="hours" value="3">
							</td>     
						</tr>     
						<tr>      
							<td class="title">강좌이름</td>
							<td colspan=3>
								<input type="text" size=60 name="lname" value="자바프로그래밍">
							</td>            
							<td class="title">최대수강인원</td>
							<td>
								<input type="text" size=5 name="capacity" value="30">
							</td>       
						</tr>      
						<tr>        
