...
@WebServlet(value = { "/product/list","/product/insert", "/product/chkcode","/product/id" })
public class ProductServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();
		String uploadPath = "c:" + File.separator + "product" + File.separator + "product" + File.separator;
		...
		vo.setCategory_code(multi.getParameter("category_code"));
