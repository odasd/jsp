...
/*
	public int codechk(String pcode, String ccode) {
		int count=-1;
		try {
			String sql="select count(*) cnt from product where product_code=? and category_code=?";
			...
			System.out.println("product codechk: "+e.toString());
		}
		return count;
	}
	*/
