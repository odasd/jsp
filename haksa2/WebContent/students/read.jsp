...
<body>
	<div id="divPage">
		...
		<div id="divContent">
		<!---------------------여기에 내용출력 시작----------------------- -->
		<div id="divHeader"><h2>학생정보</h2></div>
		<form name="frm">
			<table>
				<tr>
				...
				<tr>
					...
					<td width=300>
						...
						<input type="text" name="mm" size=2 placeholder="mm" maxlength=2 value="${fn:substring(vo.birthday,5,7)}">월
						<input type="text" name="dd" size=2 placeholder="dd" maxlength=2 value="${fn:substring(vo.birthday,8,10)}">일
					</td>
				</tr>
				<tr>
			...
			<div id="pagination">
				<input type="button" value="수정" id="btnInsert">
		...
		<table>
			<tr>
				...
				<button onClick="location.href='/haksa2/students/list.jsp'">학생목록</button>
				</td>
			</tr>
		</table>
...
getList();
	...
	$("#tbl").on("click", ".row button", function(){
		...
		if(!confirm(lname + " 강좌를 수강취소 하시겠습니까?")) return;
		$.ajax({
			type:"post",
...
$.ajax({           
	...
	$("#btnDelete").on("click", function(){
		if(!confirm(scode + " 학생를 삭제하시겠습니까?")) return;
		$.ajax({
			type:"post",
			url:"delete",
			data:{"scode":scode},
